...
int ply_type_size[] = {0, 1, 2, 4, 1, 2, 4, 4, 8, 1, 1, 2, 2, 4, 4, 4, 8};
                          ...
                          PlyProperty *prop_list)
{
  ...
  {
    fprintf(
        stderr, "ply_describe_element: can't find element '%s'\n", elem_name);
    exit(-1);
  }
                                     ...
                                     int elem_count)
{
  ...
  {
    fprintf(
        stderr, "ply_get_other_element: can't find element '%s'\n", elem_name);
    exit(-1);
  }
...
void ply_describe_other_elements(PlyFile *plyfile, PlyOtherElems *other_elems)
{
  ...
  for (i = 0; i < other_elems->num_elems; i++)
  {
    ...
    ply_describe_other_properties(
        plyfile, other->other_props, offsetof(OtherData, other_props));
  }
}
...
void ascii_get_element(PlyFile *plyfile, char *elem_ptr)
{
  ...
  for (j = 0; j < elem->nprops; j++)
  {
    ...
    { /* a list */
      ...
      get_ascii_item(words[which_word++],
                     prop->count_external,
                     &int_val,
                     &uint_val,
                     &double_val);
                       ...
                       int type)
{
  ...
  switch (type)
  {
    ...
    case PLY_INT_16:
      ...
      break;
    case PLY_INT:
    case PLY_INT_32: value = &int_val; break;
    case PLY_UCHAR:
    case PLY_UINT_8:
    ...
    case PLY_UINT_16:
      ...
      break;
    case PLY_UINT:
    case PLY_UINT_32: value = &uint_val; break;
    case PLY_FLOAT:
    case PLY_FLOAT_32:
      ...
      break;
    case PLY_DOUBLE:
    case PLY_FLOAT_64: value = &double_val; break;
    default:
    ...
    char *item, int type, int int_val, unsigned int uint_val, double double_val)
{
  ...
  {
    case PLY_CHAR:
    case PLY_INT_8: *item = char(int_val); break;
    case PLY_UCHAR:
    case PLY_UINT_8:
      puchar  = (unsigned char *)item;
